...
This repository contains my submission for the **Applied Statistics** assessment (ATU), delivered in a single Jupyter notebook: `problems.ipynb`. The notebook solves the four required problems using a mix of **analytical reasoning**, **simulation**, and **hypothesis testing**, with explanations and references included throughout.
